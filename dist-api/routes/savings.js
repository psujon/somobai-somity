...
router.post("/:id/deposit", async (req, res) => {
    ...
    try {
        ...
        if (phone) {
            sendDepositSms(phone, transaction.account.member.name, numAmount, transaction.account.accountNo, depositMonth)
...
async function sendDepositSms(phone, memberName, amount, accountNo, depositMonth, retryCount = 3) {
